...
def home(request):
    ...
    paginator = Paginator(latest_videos, 3)  # Show 6 videos per page
...
def video_list(request, category_id=None):
    ...
    paginator = Paginator(videos, 2)  # Show 2 videos per page
    page_number = request.GET.get('page')
    page_obj = paginator.get_page(page_number)
...
def video_player(request, video_id):
    ...
    # Pagination
    paginator = Paginator(related_videos, 1)  # 10 items per page
